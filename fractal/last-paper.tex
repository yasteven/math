...
Möbius Transformation at Fractal Tangencies}
...
quantum/galactic non-locality from a single mechanism. Fourth, cross-void quasar time lags
establish a true cosmic distance ladder that resolves the Hubble tension categorically,
while sparse-space attraction to dense space unifies gravity and light as two descriptions
of the same dense-sparse exchange viewed from opposite sides of the fractal boundary.
\end{abstract}

\tableofcontents
\newpage
\section{Einstein Equivalence Principle Domain Shrinks to Measure Zero}
...
scaling precisely with void diameter. The lag--diameter relation becomes the first
...
\cite{Lineweaver1996, Planck2014}) are both predicted from first principles by the dual-mechanism picture.
...
Paired quasars across well-characterized supervoids (SDSS, DESI)
will show correlated variability with lags $\tau_\text{obs} \sim 10^3$--$10^5$ years,
scaling precisely with void diameter. The lag--diameter relation is the first rung of the true
