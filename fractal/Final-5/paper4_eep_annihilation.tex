...
Consider a valid, smooth, finite‑energy initial configuration in GR: four black holes of nearly equal mass arranged in a tight tetrahedral geometry, with a small observer in the interstitial region. The initial data are smooth, globally hyperbolic, and obey all energy conditions; no pathology is built in by hand.

Under exact GR evolution, this system develops a finite‑time, finite‑proper‑time future where:
