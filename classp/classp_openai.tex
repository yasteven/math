...
% Revised corrected draft --- May 2026
% =====================================================================
...
descriptions of finite tangency updates. This revised paper develops a continuum-limit skeleton of the ASSP program, with the microscopic curvature law stated in its three-dimensional sphere form. We define a tangency graph
...
\begin{equation}
  ...
  \label{eq:edge}
\end{equation}
The packing is recursively constrained by the three-dimensional
Descartes--Soddy curvature relation~\cite{Soddy1936,Graham2003}.  For five
mutually tangent spheres with curvatures $k_i=R_i^{-1}$,
\begin{equation}
  \left(\sum_{i=1}^{5}k_i\right)^2
  =3\sum_{i=1}^{5}k_i^2.
  \label{eq:soddy_3d}
\end{equation}
Solving for the fifth curvature given $k_1,\ldots,k_4$, define
\begin{equation}
...
packing.  The continuum-limit arguments below do not require this closed-form
recursion directly; they require the induced tangency graph, finite local
second moments, and statistical balance/isotropy after coarse-graining.
...
\begin{equation}
  ...
  \label{eq:laurent}
\end{equation}
The successive radial powers have the same scaling hierarchy normally
associated with flat-rotation support ($1/r$), Newtonian gravity ($1/r^2$), GR
perihelion-precession-type corrections ($1/r^3$), and higher-order
frame-dragging-scale corrections ($1/r^4$).  This is a scaling correspondence,
not yet a coefficient-level derivation; the coefficients and exact
observational normalization remain part of the CLASSP strong-field/disk-dynamics
program.
