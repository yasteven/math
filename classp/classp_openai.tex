...
\begin{abstract}
The companion paper establishes that the universe is a finite computational object defined by a dynamical Apollonian-Soddy sphere packing fractal quine under Presburger arithmetic. This paper develops the continuum limit of that framework. The sphere radius acts as a local clock field whose coarse-grained dynamics produces Newtonian gravity and the weak-field time component of general relativity. A directed tangency walk on the same graph coarse-grains to the Dirac equation. A visual-relocation interpretation through a spherical tangency lens yields a conjectural route to the full Einstein tensor without literal spacetime curvature. The model predicts an equatorial Fermi donut in the Milky Way at 10 to 15 kiloparsecs with one-quarter the angular density contrast of the polar Fermi bubbles. This places the key observational test in the outer-disk region where Gaia DR3 data already show model-sensitive rotation curves.
\end{abstract}
