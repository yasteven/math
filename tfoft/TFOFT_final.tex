...
The standard models of physics are facing multiple observational tensions which have persisted from years to decades, with many proposed fixes being criticized as Ptolemaic-style epicycle-ing. No proposed epicyles have been able to fix the Hubble tension without breaking another part of the model, and the 94 deg quasar velocity dipole offset from the CMB which is a species-specific problem (other tracers in the same epoch do not have the same dipole) has no proposed solutions, and undermines the original identification of quasars as proof of GR-style black holes. Likewise, quantum mechanics and electromagitism predict orders of magnitude smaller effects than the experiments show in studies of Chirality-Induced Spin Selectivity, with no known fix within the QM ontology, suggesting a fundamental flaw in the theory that is worse than the orbit of Mercury was for Newton's equations. Quantum Computers have not been able to use more than 3 non-unitary full superposition'd qubits in the processing register of a quantum fourier transform, casting heavy doubt on the ontology of infinite hilbert probability spaces. Both QM and GR fail in a spectacular manner when QM is used to calculate the vacuum energy observed in the universe via the lens of GR, to 120 orders of magnitude, making QED the worst predictive theory in history, but downplays that fact by claiming to be the most successful theory via the free-parameter tuned Electron g-2 alpha constant prediction matching 12 signifigant figures. That last result is undermined by the Rb/Cs recoil alpha measurements   
